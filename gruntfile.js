...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/2015/06/tsa/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/2015/06/tsa/': 'style/project.css'
        }
      },
      upload3: {
        files: {
          '/17200/experiments/usatoday/2015/06/tsa/': 'data/*.json'
        }
      },
      upload4: {
        files: {
          '/17200/experiments/usatoday/2015/06/tsa/': 'js/main-embed.js'
        }
      },
      upload5: {
        files: {
          '/17200/experiments/usatoday/2015/06/tsa/': 'html/embed.html'
        }
      }
    },
